...
namespace BlazorBattles50.Server.Migrations
{
    ...
    [Migration("20210530044808_Battles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorBattles50.Shared.Battle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BlazorBattles50.Shared.Battle", b =>
                {
                    b.HasOne("BlazorBattles50.Shared.User", "Attacker")
                        .WithMany()
                        .HasForeignKey("AttackerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorBattles50.Shared.User", "Opponent")
                        .WithMany()
                        .HasForeignKey("OpponentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorBattles50.Shared.User", "Winner")
                        .WithMany()
